...
import com.allcom.commons.web.struts.CrudActionExBootStrap;
...
public class UserBootStrapAction extends CrudActionExBootStrap<User> {
	@Autowired
	...
	public String list() throws Exception {
		...
		try {
			...
			if (isUseJson()) {// JSON数据协议
				JsonStoreResult jsonStoreResult = new JsonStoreResult(includeProperties, page.getResult(), page
						.getTotalCount());
				//转为json字符
